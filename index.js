...
var _tshm$elm_doctest$DocTest$mergeResultIntoSpecs = F2(
	function (specs, outputs) {
		var merge = F2(
			function (spec, _p0) {
				var _p1 = _p0;
				return _elm_lang$core$Native_Utils.update(
					spec,
					{output: _p1.expression, passed: _p1.passed});
			});
		return A3(_elm_lang$core$List$map2, merge, specs, outputs);
	});
var _tshm$elm_doctest$DocTest$createTempModule = F2(
	function (src, specs) {
		var evalSpec = function (_p2) {
			var _p3 = _p2;
			var _p4 = _p3.test;
			return A2(
		...
		var newmodule = A4(
			...
			re,
			_elm_lang$core$Basics$always(newheader),
			src);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			newmodule,
			A2(_elm_lang$core$Basics_ops['++'], testDecr, footer));
	});
var _tshm$elm_doctest$DocTest$evaluationScript = '\nimport DoctestTempModule__\nimport Json.Encode exposing (object, list, bool, string, encode)\nencode 0 <| list <| \\\n  List.map (\\(r,o) -> object [(\"passed\", bool r), (\"output\", string o)])\\\n  DoctestTempModule__.doctestResults_\n';
var _tshm$elm_doctest$DocTest$Spec = F5(
	function (a, b, c, d, e) {
		return {test: a, expected: b, line: c, output: d, passed: e};
	});
var _tshm$elm_doctest$DocTest$newSpec = F3(
	function (test, expected, line) {
		return A5(_tshm$elm_doctest$DocTest$Spec, test, expected, line, '', false);
	});
var _tshm$elm_doctest$DocTest$collectSpecs = function (txt) {
	var countLines = function (m) {
		return _elm_lang$core$List$length(
			_elm_lang$core$String$lines(
				A2(_elm_lang$core$String$left, m.index, txt)));
	};
	var extract = function (m) {
		var _p5 = m.submatches;
		if ((((_p5.ctor === '::') && (_p5._0.ctor === 'Just')) && (_p5._1.ctor === '::')) && (_p5._1._0.ctor === 'Just')) {
			return A3(
				_tshm$elm_doctest$DocTest$newSpec,
				_p5._0._0,
				_p5._1._0._0,
				countLines(m));
		} else {
	...
	var re = _elm_lang$core$Regex$regex('--\\s*>>>\\s*(.+)[\\r\\n]--\\s*([^\\n\\r]+)');
	return A2(
		_elm_lang$core$List$map,
		extract,
		A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, re, txt));
};
var _tshm$elm_doctest$DocTest$Report = F2(
	function (a, b) {
		return {text: a, failed: b};
	});
var _tshm$elm_doctest$DocTest$createReport = F2(
	function (filename, specs) {
		var reportFailure = function (_p6) {
			var _p7 = _p6;
			return A2(
				_elm_lang$core$String$join,
				'\n',
					...
					[
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p7.line),
									A2(_elm_lang$core$Basics_ops['++'], ': expression ', _p7.test))))),
						A2(_elm_lang$core$Basics_ops['++'], 'expected: ', _p7.expected),
						A2(_elm_lang$core$Basics_ops['++'], ' but got: ', _p7.output),
						''
					]));
		};
		var failures = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Basics$toString(
						_elm_lang$core$List$length(specs))),
					A2(
					_elm_lang$core$Basics_ops['++'],
					'Failures: ',
					_elm_lang$core$Basics$toString(
		...
		var reports = A2(_elm_lang$core$List$map, reportFailure, failures);
		return A2(
			_tshm$elm_doctest$DocTest$Report,
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$String$join, '\n', reports),
				summary),
			_elm_lang$core$Basics$not(
				_elm_lang$core$List$isEmpty(failures)));
	});
var _tshm$elm_doctest$DocTest$Output = F2(
	function (a, b) {
		return {expression: a, passed: b};
	});
var _tshm$elm_doctest$DocTest$parseOutput = function (txt) {
	var decoder = _elm_lang$core$Json_Decode$list(
		A3(
			_elm_lang$core$Json_Decode$object2,
			_tshm$elm_doctest$DocTest$Output,
			A2(_elm_lang$core$Json_Decode_ops[':='], 'output', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'passed', _elm_lang$core$Json_Decode$bool)));
	return A2(
		_elm_lang$core$Result$withDefault,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$Json_Decode$decodeString, decoder, txt));
};
var _tshm$elm_doctest$DocTest$mergeRawOutputIntoSpecs = F2(
	function (specs, txt) {
		return A2(
			_tshm$elm_doctest$DocTest$mergeResultIntoSpecs,
			specs,
			_tshm$elm_doctest$DocTest$parseOutput(txt));
	});
var _tshm$elm_doctest$DocTest$createReportFromOutput = F3(
	function (filename, specs, output) {
		var resultSpecs = A2(_tshm$elm_doctest$DocTest$mergeRawOutputIntoSpecs, specs, output);
...
var _tshm$elm_doctest$Main$result = _elm_lang$core$Native_Platform.incomingPort(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'stdout', _elm_lang$core$Json_Decode$string),
		function (stdout) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				...
				function (filename) {
					return _elm_lang$core$Json_Decode$succeed(
						{stdout: stdout, filename: filename});
				});
		}));
var _tshm$elm_doctest$Main$evaluate = _elm_lang$core$Native_Platform.outgoingPort(
	'evaluate',
	function (v) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _tshm$elm_doctest$Main$main === 'undefined' ? null : _tshm$elm_doctest$Main$main);
